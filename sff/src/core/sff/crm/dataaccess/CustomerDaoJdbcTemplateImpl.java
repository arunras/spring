...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
  ...
  public void update(Customer customerToUpdate) throws RecordNotFoundException {
    int rowsUpdate = template.update(UPDATE_CUSTOMER_SQL,
  ...
  public Customer getFullCustomerDetail(String customerId) throws RecordNotFoundException {
    ...
    List<Call> allCallsForCustomer = template.query("SELECT * FROM tbl_call WHERE cusomer_id = ?",
                                                          new CallRowMapper(),
                                                          customerId);
...
class CustomerRowMapper implements RowMapper<Customer> {
  ...
  public Customer mapRow(ResultSet rs, int rowNumber) throws SQLException {
    ...
    String customerName = rs.getString("COMPANY_NAME");
    String email = rs.getString("EMAIL");
    String telephone = rs.getString("TELEPHONE");
    String notes = rs.getString("NOTES"); 
    return new Customer(customerId, customerName, email, telephone, notes);
  }
}
